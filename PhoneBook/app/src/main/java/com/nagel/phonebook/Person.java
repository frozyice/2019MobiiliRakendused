...
public class Person implements java.io.Serializable
{
  ...
  public Person(String firstname, String lastname, String address, Zipcode zipcode, String phone, String mail,
                String date, String title, String description) {
    this(0, firstname, lastname, address, zipcode, phone, mail, date, title, description);
  }

  public Person(int id, String firstname, String lastname, String address, Zipcode zipcode, String phone,
